...
{
    public partial class selectCosInvoice : Form
    {
        private bool Clicked = false, FLAG = false;
        string mID = "";
        EdenDbDataSetTableAdapters.CosmeticItemSoldTableAdapter getItem = new EdenDbDataSetTableAdapters.CosmeticItemSoldTableAdapter();
        ...
        public selectCosInvoice(bool flag)
        {
            InitializeComponent();
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                if (dataGridView1.Focused)
                {
                    ...
                    Selected = ToArray(getItem.GetDataByCosTransID2(mID));
                    Clicked = true;
                    this.Close();
                }
            }
        ...
        private void selectCosInvoice_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'edenDbDataSet.CosmeticItemSold' table. You can move, or remove it, as needed.
            this.cosmeticItemSoldTableAdapter.Fill(this.edenDbDataSet.CosmeticItemSold);
